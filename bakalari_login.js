...
async function creteForLoginForm() {
    ...
    var editbgsvg = document.createElementNS("http://www.w3.org/2000/svg", "svg");
    editbgsvg.setAttribute("height", "24");
    editbgsvg.setAttribute("viewBox", "0 -960 960 960");
    editbgsvg.setAttribute("width", "24");
    editbgsvg.setAttribute("style", "margin: auto; display: block; height: -webkit-fill-available;");
